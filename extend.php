...
return [
    ...
    ->content(function (Document $document) {
        ...
        $document->head[] = '<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/ramesh-dada/Flarum-GUI-Image-and-Link/assets/image-and-link-gui.js?pleaseshownew"></script>';
    })
