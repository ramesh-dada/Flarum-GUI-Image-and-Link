  ...
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_common_components_TextEditor__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'toolbarItems', function (items) {
    items.add('ramesh-dada-premium-imagegui', m('button', {
      ...
      onclick: function onclick() {
        return rameshimageGUI();
      }
    }, [m('i', {
      "class": 'fas fa-image'
    })], [m('span', {
      "class": 'Button-label'
    }, flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('ramesh.imageGUI'))]), 2);
  });
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_common_components_TextEditor__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'toolbarItems', function (items) {
    items.add('ramesh-dada-premium-linkgui', m('button', {
      ...
      onclick: function onclick() {
        return rameshlinkGUI();
      }
    }, [m('i', {
      "class": 'fas fa-link'
    })], [m('span', {
      "class": 'Button-label'
    }, flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('rames.hlinkGUI'))]), 3);
  });
});
